...
**1. Declare Potent Action:** Activate the Talent or condition that grants Potency (e.g., "I cast this spell as a Ritual, making it Potent")

**2. Assess Improved Vantage:** 
- GM determines your normal Vantage for this action
- Improve it by 1 tier (Impossible → Limited → Strong → Certain)

**3. Apply Edge:**
- If the Challenge has Complications, your 1 Edge ignores 1 of them
- Choose which Complication to ignore if multiple apply

**4. Roll (if needed):**
- If your improved Vantage is Strong or Limited, roll normally
- If Certain, auto-succeed

**5. Resolve Outcome:**
- Apply results normally
- If you roll Conflict or better and have a relevant Trait, you may invoke it for a Special Effect (as usual)
...
When Potency improves your Vantage to Certain, you auto-succeed:

**Straightforward actions:** Automatic success, describe the feat
- Potent Fireball against stationary target → hits, marks ticks
- Potent Feat of Strength to lift boulder → lifts it easily

**Complex situations:** GM may rule the action remains Strong if circumstances are still challenging
- Potent Fireball against dragon in a windstorm → Strong (roll with environmental factors)
- Potent Feat of Strength to hold collapsing gate while injured → Strong (Wounded Condition applies)

**Edge is irrelevant for Certain actions** since you auto-succeed without rolling. The improved Vantage is reward enough.
...
### Multiple Sources of Potency

**Potency does not stack.** If you have multiple sources that could grant Potency on the same action, you only gain the benefit once (Vantage +1 tier, 1 Edge).

**Example:** A Mystic has both "Potent Spells (Ritual)" and "Potent Divine Magic (when channeling deity)." If casting a ritual spell while channeling their deity, they gain Vantage +1 tier and 1 Edge, not +2 tiers and 2 Edge.
...
This section should be added to **Chapter 2: Core Mechanics** after the Expertise section. It's a core mechanic that modifies action resolution and should be understood before players encounter Talents that grant Potency.
