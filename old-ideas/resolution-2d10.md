...
When a Trait is narratively relevant to your action, you may **take 1 Bane** before rolling to gain a **Special Effect** (if you succeed):
- **Declare before rolling:** Take 1 Bane (roll extra d10, drop highest)
...
- **Declare:** Take 1 Bane to gain Special Effect if successful
