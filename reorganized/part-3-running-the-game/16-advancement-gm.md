...
**Award levels based on narrative milestones, not XP totals or session count.** Advancement should feel earned and tied to story progress — the party solved the mystery, defeated the warlord, saved the city, or accomplished something that clearly marks growth.

### Milestone Guidelines

**Levels 2-3:** After completing your first major arc.
- Saving the village, defeating the local threat, solving the central mystery
...
**Levels 8-9:** After multiple mythic accomplishments.
...
A milestone is a moment where the fiction clearly says "these characters have grown." Look for:

- **Stakes were high and they rose to meet them**
- **Their approach or understanding changed** (not just "they fought more things")
- **The world is different because of their actions**
- **Players feel their characters have learned or transformed**

Don't award levels for attendance. Award them when the story earns it.

---

## Campaign Pacing

Different campaign lengths demand different advancement speeds.
...
- The party has a reputation — people know their names
- Political factions take notice (for better or worse)
- Enemies become more organized and resourceful

**What changes mechanically:**
- Characters have 4-5 dice in their primary Approach
- 3-4 Talents provide real specialization
- Momentum economy is more fluid (more ways to earn and spend)
- Party coordination becomes more sophisticated

**GM adjustment:**
- Introduce recurring antagonists with plans and resources
- Give Challenges 1-2 Complications regularly (not just bosses)
...
- Use Legendary Complication on signature foes
- Environmental stakes matter more than individual enemies
...
**What changes mechanically:**
- Maximum Approach ratings, full Talent suites
- Characters are broadly competent and deeply specialized
- Standard encounters are narrative color, not mechanical challenges
- Only the most extreme opposition creates genuine risk

**GM adjustment:**
- Reserve full mechanical combat for the 2-3 final encounters
- Focus on narrative weight and consequence rather than mechanical challenge
- Let them demolish lesser threats cinematically
- The campaign's climax should test everything they've built

---

## End of Session Questions (Optional)

At the end of each session, the group can answer these questions together. Answering "yes" to any earns the group 1 progress toward their next milestone (GM decides how many "yes" answers equal a level — typically 3-5 per level for medium campaigns).
...
- "Did someone's Drive create a genuine complication?"

These are **optional**. Some groups prefer pure narrative milestones (GM judgment). Others like the structure of questions. Use whichever keeps advancement feeling earned and exciting.
